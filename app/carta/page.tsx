...
const cartaItems = [
  ...
  },
  {
    ...
    alt: 'Pasta casera para llevar, AriMar FoodLab Playa de Arinaga',
    title: 'Pastas',
    description: 'Platos de pasta casera.',
  },
  {
      ...
      <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <header className="text-center mb-12">
            ...
            {/* Categorías en ul/li con estilo chips */}
            <nav aria-label="Categorías de la carta">
              <ul className="flex flex-wrap justify-center gap-2 md:gap-3 list-none pl-0">
                {categories.map((cat) => (
                  <li key={cat}>
                    <span
                      className="inline-block px-4 py-2 rounded-full border border-primary-100/70 bg-primary-50/60 text-sm md:text-base text-primary-800/90 shadow-sm hover:bg-primary-50/80 transition-colors"
                    >
                      {cat}
                    </span>
                  </li>
