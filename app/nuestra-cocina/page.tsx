  ...
  return (
    <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <section className="mb-20" aria-labelledby="produccion-heading">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 id="produccion-heading" className="text-3xl md:text-4xl font-bold text-slate-800 mb-6 tracking-tight">
                Producción real
              </h2>
        ...
        <section className="mb-20" aria-labelledby="rational-heading">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center mb-14">
            ...
            >
              <p>
                En AriMar FoodLab trabajamos con tecnología RATIONAL para que el resultado sea constante: platos con el punto exacto, cada día. Método, control y cariño para cocinar mejor y servir mejor.
              </p>
              <p>
                Nuestra comida para llevar en Playa de Arinaga (Agüimes), Gran Canaria, se elabora con estos equipos para ofrecerte la misma calidad día a día.
              </p>
            </motion.div>
          </div>
